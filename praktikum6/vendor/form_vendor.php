...
<body>
    <h2 style="margin-top: 3%" class="text-center">Isi Data Vendor</h2>
...
<form method="POST" action="proses_vendor.php" style="margin-top: 5%; margin-left: 30%;">
    ...
    <label for="kota" class="col-4 col-form-label">Kota</label> 
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="kota" name="kota" value="" type="text" class="form-control col-md-4">
            </div>
        </div>
    </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      ...
      class="btn btn-info" value="Simpan"/>
